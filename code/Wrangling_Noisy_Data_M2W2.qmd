...
## Example of working w/ tidy data
...
## Pivoting data: Lengthening datasets
...
## Pivoting data: widening datasets (decrease rows & increase columns)
...
print(sensor_clean)
```
## Joining tables based on a a common identifying column or key
