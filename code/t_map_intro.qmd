...
This file goes over basic syntax and commands for how to use the t_map package when conducting spatial analysis, most of the code is copied from the following repository authored by Nico Hahn: https://github.com/nicoFhahn/geocomputation

NOTE: code is outdated and has limited use
