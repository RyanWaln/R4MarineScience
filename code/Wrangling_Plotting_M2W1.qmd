...
```{r source-script1}
#| results: hide  # hides long results when rendering sourced scripts
source("Workshop1.R")
```
...
```{r}
# Always a good idea to run base r scripts to format data before hand if it takes many steps to get it into a format you can start exploring 
...
### Saving figures is the last step in most R projects